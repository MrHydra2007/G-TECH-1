...
GameOverMenu::GameOverMenu(SDL_Renderer* rend, Game* g) : Menu("GameOverMenu", rend, g) {
...
void GameOverMenu::render()
{
	...
	UIManager::getInstance().renderTitle("Looser !", (int)(titleX + titleWidth * 0.03f), (int)(titleY + titleHeight * 0.13f), titleColor, titleFontSize);
...
void GameOverMenu::executeOption()
{
	switch (selected) {
	case 0:
