...
PauseMenu::PauseMenu(SDL_Renderer* rend, Game* g) : Menu("PauseMenu", rend, g)
{
...
{
	std::cout << "[PauseMenu] Entering Pause Menu\n";
	selected = 0;
}

bool PauseMenu::handleInput()
{
...
void PauseMenu::render()
{
	...
	UIManager::getInstance().renderTitle("Pause Menu", (int)(titleX + titleWidth * 0.09f), (int)(titleY + titleHeight * 0.13f), titleColor, titleFontSize);
