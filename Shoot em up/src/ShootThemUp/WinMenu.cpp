...
WinMenu::WinMenu(SDL_Renderer* rend, Game* g) : Menu("GameOverMenu", rend, g) {
...
void WinMenu::render()
{
	...
	UIManager::getInstance().renderTitle("Winner !", (int)(titleX + titleWidth * 0.03f), (int)(titleY + titleHeight * 0.13f), titleColor, titleFontSize);
